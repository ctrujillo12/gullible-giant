import { d as createAstro, c as createComponent, e as addAttribute, a as renderTemplate, m as maybeRenderHead, s as spreadAttributes, f as renderSlot, r as renderComponent, g as renderHead } from '../../chunks/astro/server_CLdCtpUm.mjs';
import 'kleur/colors';
import { S as SITE_TITLE, r as renderEntry, g as getCollection } from '../../chunks/consts_CjR9BYtl.mjs';
import 'clsx';
/* empty css                                     */
import { _ as __ASTRO_IMAGE_IMPORT_Z1F4X4R } from '../../chunks/blog-placeholder-1_BgRddN67.mjs';
import '@astrojs/internal-helpers/path';
import '@astrojs/internal-helpers/remote';
import { $ as $$Image } from '../../chunks/_astro_assets_f8keDQ62.mjs';
export { renderers } from '../../renderers.mjs';

const $$Astro$6 = createAstro("https://boisterous-valkyrie-62854e.netlify.app");
const $$BaseHead = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$BaseHead;
  const canonicalURL = new URL(Astro2.url.pathname, Astro2.site);
  const { title, description, image = __ASTRO_IMAGE_IMPORT_Z1F4X4R } = Astro2.props;
...
}, "C:/Projects/Website/gullible-giant/src/components/BaseHead.astro", void 0);

const $$Astro$5 = createAstro("https://boisterous-valkyrie-62854e.netlify.app");
...
}, "C:/Projects/Website/gullible-giant/src/components/Footer.astro", void 0);

const $$Astro$2 = createAstro("https://boisterous-valkyrie-62854e.netlify.app");
...
}, "C:/Projects/Website/gullible-giant/src/components/FormattedDate.astro", void 0);

const $$Astro$1 = createAstro("https://boisterous-valkyrie-62854e.netlify.app");
...
}, "C:/Projects/Website/gullible-giant/src/layouts/BlogPost.astro", void 0);
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$;
  Astro2.props;
  const { Content, data } = await renderEntry(Astro2.props);
  return renderTemplate`${data.heroImage && renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": data.heroImage, "alt": data.title, "style": "width: 100%; border-radius: 12px; margin-bottom: 2rem;" })}`}${renderComponent($$result, "BlogPost", $$BlogPost, { ...data }, { "default": async ($$result2) => renderTemplate`${renderComponent($$result2, "Content", Content, {})}` })}`;
}, "C:/Projects/Website/gullible-giant/src/pages/blog/[...slug].astro", void 0);

const $$file = "C:/Projects/Website/gullible-giant/src/pages/blog/[...slug].astro";
const $$url = "/blog/[...slug]";
