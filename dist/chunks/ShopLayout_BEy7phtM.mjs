import { d as createAstro, c as createComponent, f as renderSlot, g as renderHead, a as renderTemplate } from './astro/server_CLdCtpUm.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
...
• H O M E •
</textPath> </text> </svg> </a> <div class="nav-links" data-astro-cid-ipno7jli> <!-- <a href="/">Home</a> --> <!-- <a href="/projects">Projects</a> --> <a href="/mypicks" data-astro-cid-ipno7jli>My Picks</a> <!-- <a href="/diary">Diary</a> --> <a href="/spotify" data-astro-cid-ipno7jli>Music</a> <!-- </a>class="spotify-link" aria-label="Spotify">
            <img src="/images/spotify--v2.png" alt="Spotify" />
          </a> --> <a href="/about" data-astro-cid-ipno7jli>Connect</a> </div> </nav> </header> <main data-astro-cid-ipno7jli> ${renderSlot($$result, $$slots["default"])} </main> <footer data-astro-cid-ipno7jli> <div class="footer" data-astro-cid-ipno7jli></div>
© ${(/* @__PURE__ */ new Date()).getFullYear()} ctrujillo — made with Astro
</footer> </body></html>`;
